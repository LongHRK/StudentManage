<?php
    ...
    $classroom = new Apps_Model_ClassRoom();
?>
...
<html lang="en">
        ...
        <div id="content-insert-div">
            <form action="#" method="post" enctype="multipart/form-data">
                <table class="content-insert">
                    <tr>
                        <td class="col-info">Room ID</td>
                        <td class="col-input"><input type="text" name="idcr" class="txtinput"></td>
                    </tr>
                    <tr>
                        <td class="col-info">Room Name</td>
                        <td class="col-input"><input type="text" name="namecr" class="txtinput"></td>
                    </tr>
                    <tr>
    ...
    if (!$pages->getPOST("idcr") || !$pages->getPOST("namecr")) {
            ...
            try {
                $classroom->buildparam([
            "field" => "(id,name) VALUES (?,?)",
            "values" => [
                $pages->getPOST("idcr"),
                $pages->getPOST("namecr")
            ]
            ])->insert();

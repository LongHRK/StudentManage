    ...
    <div class="main-show">
        <div class="container-header"> 
            <form action="#" method="GET">
                <div class="header-btnadd">
                    <input type="button" name="btnadd" class="btn-handle" value="Add Class Room" id="btnadd" onclick="Showinsert()">
                </div>
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        <tr class="row-data" id="<?php echo 'row' . $i ?>">
                            ...
                            <td class="col2">
                                ...
                                <input type="text" name="idroom" readonly="readonly" value="<?php echo $value["id"] ?>" id="col-2-in" class="input">
                            </td>
                            <td class="col3">
                                <p id="col-3" class="data"><?php echo $value["name"] ?></p>
                                <input type="text" name="nameroom" value="<?php echo $value["name"] ?>" id="col-3-in" class="input">
                            </td>
                    ...
                    $result = $room->buildparam(
                        [
                           "field"=>"name=?", 
                            "where"=>"id=?",
                            "values"=>[
                                $page->getPOST("nameroom"),
                                $page->getPOST("idroom")
                            ]
                        ]
                )->update();
            echo '<script language="javascript">';
            echo "location.replace('http://localhost/StudentManage/Admin/ManageClass/Show.php');";
            echo '</script>';
                } catch (Exception $ex) {
                    echo '<script language="javascript">';
        ...
        <script type="text/javascript">
                                        ...
                                        function Deletedata(id) {
                                            option = confirm("Do you want delete this class room?");
                                            if (!option) {
                                                return;
                                            }
                                            console.log(id);

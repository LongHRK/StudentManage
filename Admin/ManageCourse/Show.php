    ...
    <div class="main-show">
        <div class="container-header"> 
            <form action="#" method="GET">
                <div class="header-btnadd">
                    <input type="button" name="btnadd" class="btn-handle" value="Add Course" id="btnadd" onclick="Showinsert()">
                </div>
        ...
        <div id="container-table" class="container-tables active">
            <table>
                <thead>
                <td class="col1">NO</td>
                <td class="col2">Course ID</td>
                <td class="col3">Course Name</td>
                ...
                <tbody>
                    ...
                    if ($search) {
                        ...
                        $totalresult = $course->buildparam([])->select();
                            foreach ($totalresult as $a){
                                $totalitem++;
                            }
                            $totalpage = ceil($totalitem / $item_per_page);
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        <tr class="row-data" id="<?php echo 'row' . $i ?>">
                            ...
                            <td class="col2">
                                ...
                                <input type="text" name="idcourse" readonly="readonly" value="<?php echo $value["id"] ?>" id="col-2-in" class="input">
                            </td>
                            <td class="col3">
                                <p id="col-3" class="data"><?php echo $value["name"] ?></p>
                                <input type="text" name="namecourse" value="<?php echo $value["name"] ?>" id="col-3-in" class="input">
                            </td>
                    ...
                    $result = $course->buildparam(
                        [
                           "field"=>"name=?", 
                            "where"=>"id=?",
                            "values"=>[
                                $page->getPOST("namecourse"),
                                $page->getPOST("idcourse")
                            ]
                        ]
                )->update();
        ...
        <script type="text/javascript">
                                        ...
                                        function Deletedata(id) {
                                            option = confirm("Do you want delete this Course?");
                                            if (!option) {
                                                return;
                                            }
                                            console.log(id);

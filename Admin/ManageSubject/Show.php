    ...
    <div class="main-show">
        <div class="container-header"> 
            <form action="#" method="GET">
                <div class="header-btnadd">
                    <input type="button" name="btnadd" class="btn-handle" value="Add Subjects" id="btnadd" onclick="Showinsert()">
                </div>
        ...
        <div id="container-table" class="container-tables active">
            <table>
                <thead>
                <td class="col1">NO</td>
                <td class="col2">Subject ID</td>
                <td class="col3">Subject Name</td>
                <td class="col4">Credits Number</td>
                <td class="col5">Lesson Number</td>
                ...
                <tbody>
                    ...
                    $subject = new Apps_Model_Subject();
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        <tr class="row-data" id="<?php echo 'row' . $i ?>">
                            ...
                            <td class="col2">
                                ...
                                <input type="text" name="idsubject" readonly="readonly" value="<?php echo $value["id"] ?>" id="col-2-in" class="input">
                            </td>
                            <td class="col3">
                                <p id="col-3" class="data"><?php echo $value["name"] ?></p>
                                <input type="text" name="namesubject" value="<?php echo $value["name"] ?>" id="col-3-in" class="input">
                            </td>
                            <td class="col4">
                                <p id="col-4" class="data"><?php echo $value["credits"] ?></p>
                                <input type="number" name="creditssubject" value="<?php echo $value["credits"] ?>" id="col-4-in" class="input">
                            </td>
                            <td class="col5">
                                <p id="col-5" class="data"><?php echo $value["numberlesson"] ?></p>
                                <input type="number" name="lessonsubject" value="<?php echo $value["numberlesson"] ?>" id="col-5-in" class="input">
                            </td>
            ...
            if ($page->getPOST("btnsave")) {
                try {
                    $result = $subject->buildparam(
                        [
                           "field"=>"name=?,credits=?,numberlesson=?", 
                            "where"=>"id=?",
                            "values"=>[
                                $page->getPOST("namesubject"),
                                $page->getPOST("creditssubject"),
                                $page->getPOST("lessonsubject"),
                                $page->getPOST("idsubject")
                            ]
                        ]
                )->update();
        ...
        <script type="text/javascript">
                                        ...
                                        function Deletedata(id) {
                                            option = confirm("Do you want delete this subject?");
                                            if (!option) {
                                                return;
                                            }
                                            console.log(id);

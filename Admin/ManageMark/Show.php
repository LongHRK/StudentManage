...
<body>
    <div class="main-show">
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        <tr class="row-data" id="<?php echo 'row' . $i ?>">
                            ...
                            <td class="col4">
                                ...
                                <input type="number" min="0" max="10" step="any" name="markbynumber" value="<?php echo $value["markbynumber"] ?>" id="col-4-in" onchange="SetValuesText()" onkeyup="SetValuesText()" class="input">
                            </td>
                            <td class="col5">
                                <p id="col-5" class="data"><?php echo $value["markbyword"] ?></p>
                                <input type="text" readonly="readonly" name="markbyword" value="<?php echo $value["markbyword"] ?>" id="col-5-in" class="input">
                            </td>
        ...
        <script type="text/javascript">
                                    ...
                                    function SetValuesText(){
                                        var x = document.getElementById("col-4-in").value;
                                        document.getElementById("col-5-in").value = toWords(x);
                                    }                                    
        </script>
    </div>
</body>

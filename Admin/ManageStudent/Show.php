    ...
    <div class="main-show">
        <div class="container-header"> 
            <form action="#" method="GET">
                <div class="header-btnadd">
                    <input type="button" name="btnadd" class="btn-handle" value="Add Student" id="btnadd" onclick="Showinsert()">
                </div>
        ...
        <div id="container-table" class="container-tables active">
            <table>
                ...
                <td class="col6">Home Town</td>
                <td class="col7">Avatar</td>
                <td class="col8">Handle</td>
                </thead>
                <tbody>
                    <?php
                    $item_per_page = 5;
                    ...
                    if ($search) {
                        ...
                        $totalresult = $student->buildparam([
                            "where" => "name like '%" . $page->getGet("txtsearch") . "%'"
                        ])->select();
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        <tr class="row-data" id="<?php echo 'row' . $i ?>">
                            ...
                            <td class="col2">
                                ...
                                <input type="text" name="idstudent" readonly="readonly" value="<?php echo $value["id"] ?>" id="col-2-in" class="input">
                            </td>
                            <td class="col3">
                                <p id="col-3" class="data"><?php echo $value["name"] ?></p>
                                <input type="text" name="namest" value="<?php echo $value["name"] ?>" id="col-3-in" class="input">
                            </td>
                            <td class="col4">
                                <p id="col-4" class="data"><?php echo $value["birthday"] ?></p>
                                <input type="date" name="birthdayst" value="<?php echo $value["birthday"] ?>" id="col-4-in" class="input">
                            </td>
                            <td class="col5">
                                <p id="col-5" class="data"><?php echo $value["gender"] ?></p>
                                <div id="col-3-in" class="input">
                                    <input type="radio" value="Nam" name="genderst">Nam&nbsp;
                                    <input type="radio" value="Nữ" name="genderst" >Nữ&nbsp;
                                    <input type="radio" value="Khác" name="genderst" >Khác
                                </div>
                            </td>
                            <td class="col6">
                                <p id="col-6" class="data"><?php echo $value["hometown"] ?></p>
                                <input type="text" name="hometownst" value="<?php echo $value["hometown"] ?>" id="col-6-in" class="input">
                            </td>
                            <td class="col7">
                                <p id="col-7" class="data"><?php
                                ...
                                <input type="file" name="avatarst" id="col-7-in" class="input">
                            </td>
                            <td id="td-handle" class="col8">
                                <p id="col-8" class="data">
            ...
            if ($page->getPOST("btnsave")) {
                ...
                $linking = $student->buildparam([
                    "select"=>"avatar",
                    "where"=>"id = ?",
                    "values"=>[$page->getPOST("idstudent")]
                ])->selectone();
                
                if (isset($_FILES["avatarst"]) && !isset($_FILES["avatarst"]["errors"])) {
                    move_uploaded_file($_FILES["avatarst"]["tmp_name"], "../../Public/StoreImage/" . $_FILES["avatarst"]["name"]);
                }

                $imageupdate = "../../Public/StoreImage/" . $_FILES["avatarst"]["name"];
                    ...
                    $result = $student->buildparam(
                        [
                           "field"=>"name=?,birthday=?,gender=?,hometown=?,avatar=?", 
                            ...
                            "values"=>[
                                $page->getPOST("namest"),
                                $page->getPOST("birthdayst"),
                                $page->getPOST("genderst"),
                                $page->getPOST("hometownst"),
                                $imageupdate,
        ...
        <script type="text/javascript">
                                        function AddClass(id,radio) {
                                            ...
                                            var check = document.getElementsByName("genderst");
                                        ...
                                        function Deletedata(id) {
                                            option = confirm("Do you want delete this student?");
                                            if (!option) {
                                                return;
                                            }
                                            console.log(id);

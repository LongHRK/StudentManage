    ...
    <div class="main-show">
        <div class="container-header"> 
            <form action="#" method="GET">
                <div class="header-btnadd">
                    <input type="button" name="btnadd" class="btn-handle" value="Add Schedule" id="btnadd" onclick="Showinsert()">
                </div>
        ...
        <div id="container-table" class="container-tables active">
            <table>
                <thead>
                <td class="col1">NO</td>
                <td class="col2">Day</td>
                <td class="col3">Time</td>
                <td class="col4">Time Start</td>
                <td class="col5">Time End</td>
                <td class="col6">ID Room</td>
                <td class="col7">ID Subjects</td>
                <td class="col8">ID Teacher</td>
                ...
                <tbody>
                    ...
                    if ($getCourse) {
                        ...
                        $totalresult = $schedule->buildparam([
                            "where" => "idcourse = '".$getCourse."'"
                        ])->select();
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        <tr class="row-data" id="<?php echo 'row' . $i ?>">
                            <td class="col1">
                            <p id="col-1" class="data"><?php echo $i ?></p>
                            <input type="hidden" readonly="readonly" name="idschedule" value="<?php echo $value["id"] ?>" id="col-1-in" class="input">
                            </td>
                            <td class="col2">
                                <p id="col-2" class="data"><?php echo $value["day"] ?></p>
                                <input type="text" name="dayschedule" value="<?php echo $value["day"] ?>" id="col-2-in" class="input">
                            </td>
                            <td class="col3">
                                <p id="col-3" class="data"><?php echo $value["timeday"] ?></p>
                                <input type="text" name="timedayschedule" value="<?php echo $value["timeday"] ?>" id="col-3-in" class="input">
                            </td>
                            <td class="col4">
                                <p id="col-4" class="data"><?php echo $value["timestart"] ?></p>
                                <input type="date" name="timestartschedule" value="<?php echo $value["timestart"] ?>" id="col-4-in" class="input">
                            </td>
                            <td class="col5">
                                <p id="col-5" class="data"><?php echo $value["timeend"] ?></p>
                                <input type="date" name="timeendschedule" value="<?php echo $value["timeend"] ?>" id="col-5-in" class="input">
                            </td>
                            <td class="col6">
                                <p id="col-6" class="data"><?php echo $value["idclassroom"] ?></p>
                                <input type="text" name="idroomschedule" value="<?php echo $value["idclassroom"] ?>" id="col-6-in" class="input">
                            </td>
                            <td class="col5">
                                <p id="col-5" class="data"><?php echo $value["idsubjects"] ?></p>
                                <input type="text" name="idsubjectsschedule" value="<?php echo $value["idsubjects"] ?>" id="col-7-in" class="input">
                            </td>
                            <td class="col5">
                                <p id="col-5" class="data"><?php echo $value["idteacher"] ?></p>
                                <input type="text" name="idteacherschedule" value="<?php echo $value["idteacher"] ?>" id="col-8-in" class="input">
                            </td>
                            <td id="td-handle" class="col9">
            ...
            if ($page->getPOST("btnsave")) {
                try {
                    $schedule->buildparam(
                        [
                           "field"=>"day=?,timeday=?,timestart=?,timeend=?,idclassroom=?,idsubjects=?,idteacher=?", 
                            "where"=>"id = ?",
                            "values"=>[
                                $page->getPOST("dayschedule"),
                                $page->getPOST("timedayschedule"),
                                $page->getPOST("timestartschedule"),
                                $page->getPOST("timeendschedule"),
                                $page->getPOST("idroomschedule"),
                                $page->getPOST("idsubjectsschedule"),
                                $page->getPOST("idteacherschedule"),
                                $page->getPOST("idschedule")
                            ]
                        ]
                )->update();
        ...
        <script type="text/javascript">
                                        ...
                                        function Deletedata(id) {
                                            option = confirm("Do you want delete this Subjects from the Schedule?");
                                            if (!option) {
                                                return;
                                            }
                                            $.post('./Delete.php', {

...
<body>
    ...
    <div class="content">
        ...
        <div class="content__content">
            ...
            <div class="row">
                <div class="col1">Salary</div>
                <div class="col2"><input type="text" name="salary" value="<?php echo $result["salary"] ?>" id=""></div>
            </div>
            <div class="row">
    ...
    if ($page->getPOST("update")) {
        ...
        try {
            ...
            echo "location.replace('http://localhost/StudentManage/Teacher/Home.php');";
            echo '</script>';
        } catch (Exception $ex) {
            echo '<script language="javascript">';
